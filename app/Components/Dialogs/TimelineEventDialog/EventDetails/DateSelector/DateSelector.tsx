...
import { Box, Button, DialogContent, MenuItem, SelectChangeEvent, TextField, Tooltip, Typography } from "@mui/material";
...
export default function DateSelector({
    ...
    return (
        <>
            {userGroups?.includes("admin") && <Button onClick={printVariables}>Print Variables</Button>}
