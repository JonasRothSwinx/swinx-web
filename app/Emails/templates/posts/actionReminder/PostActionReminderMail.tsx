...
function NewPostActionReminder(props: DebugToggle) {
    const { name, postTime, customerName, customerProfileLink /*  postContent */, taskPageLink } = props.debug
        ? defaultParams
        : placeholders;
    return (
        <Html dir="ltr" lang="de">
            ...
            <Text style={styles.text}>
                Wir möchten Sie daran erinnern, dass Sie {postTime} einen Beitrag für {customerName} veröffentlichen
                sollen.
            </Text>
            <Text style={styles.text}>
                Wichtig: <br />
...
function ReducedPostActionReminder(props: DebugToggle) {
    ...
    return (
        <Html dir="ltr" lang="de">
            ...
            <Text style={styles.text}>
                Wir möchten dich daran erinnern, dass du heute um {postTime} einen Beitrag für {customerName}
