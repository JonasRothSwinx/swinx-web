...
//     data: Partial<TimelineEvent.Video>;
// }
...
//         maxDuration: (value) => {
//             onChange((prev) => {
//                 return { ...prev, details: { ...prev.details, maxDuration: value } };
//             });
//         },
//         charLimit: (value) => {
//             return;
...
//                 value={data.details?.maxDuration ?? ""}
//                 onChange={(e) => ChangeHandler.maxDuration(e.target.value)}
//                 // fullWidth
//                 variant="standard"
//             />
//             <TextField
