                ...
                {events.map((event) => {
                    ...
                    return (
                        <Typography key={event.id}>
                            Sie werden ein Impuls-Video zum Thema <strong>{eventTitle}</strong> für
                            den Kunden erstellen, das im Webinar des Kunden gezeigt wird.
                            <br />
                            {draftDeadline && (
                                <>
                                    Die Aufnahme muss bis zum{" "}
                                    <strong>{dayjs(draftDeadline).format("DD.MM.")}</strong> bei uns
                                    eingeschickt werden.
                                    <br />
                                </>
                            )}
                            {maxDuration && (
                                <>
                                    Das Video darf maximal <strong>{maxDuration}</strong> Minuten
                                    lang sein.
                                </>
                            )}
                        </Typography>
