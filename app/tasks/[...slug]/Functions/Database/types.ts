...
export type TimelineEvent = Prettify<
    NonNullable<Awaited<ReturnType<typeof dataClient.getEventsByAssignment>>[number]>
>;
export type ParentEvent = Prettify<
    NonNullable<Awaited<ReturnType<typeof dataClient.getEventInfo>>>
>;
